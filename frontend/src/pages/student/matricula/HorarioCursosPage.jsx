...
import { programas } from "../../../data/matricula";
...
const HorarioCursosPage = () => {
  ...
  const maestrias = [...programas.especializacion, ...programas.investigacion];
  ...
  return (
    <div className="min-h-screen bg-unmsm-bg">
      <PageHero
        ...
        subtitle="Selecciona tu programa para ver los horarios disponibles"
        image={MATRICULA_HERO_IMAGE}
      />

      <div className="max-w-6xl mx-auto px-4 py-12 space-y-6">
        <InfoBanner icon={MdAccessTime} title="Horarios de Cursos 2026-II" tone="blue">
