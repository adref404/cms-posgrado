...
export const ADMIN_NOVEDADES_CONFIG = {
  noticias: {
    ...
    campos: [
      ...
      { nombre: "cuerpo", etiqueta: "Cuerpo de la noticia", tipo: "richtext" },
  ...
  eventos: {
    ...
    campos: [
      ...
      { nombre: "imagen", etiqueta: "Imagen", tipo: "imagen" },
      { nombre: "cuerpo", etiqueta: "Cuerpo del evento", tipo: "richtext" },
  ...
  comunicados: {
    ...
    campos: [
      ...
      { nombre: "fecha", etiqueta: "Fecha", tipo: "fecha", requerido: true },
      { nombre: "imagen", etiqueta: "Imagen", tipo: "imagen" },
      { nombre: "cuerpo", etiqueta: "Cuerpo del comunicado", tipo: "richtext" },
