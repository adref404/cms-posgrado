...
export const autoridades = [
  ...
  {
    unit: "Vicedecanato Académico",
    role: "Vicedecano Académico",
  ...
  {
    unit: "Vicedecanato de Investigación y Posgrado",
    role: "Vicedecano",
  ...
  {
    unit: "Instituto de Investigación Educativas",
    role: "Director",
